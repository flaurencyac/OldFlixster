...
public final class ItemMovieBinding implements ViewBinding {
  ...
  private ItemMovieBinding(@NonNull RelativeLayout rootView, @NonNull ImageView ivPoster,
      @NonNull TextView tvOverview, @NonNull TextView tvTitle) {
  ...
  public static ItemMovieBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMovieBinding((RelativeLayout) rootView, ivPoster, tvOverview, tvTitle);
    }
